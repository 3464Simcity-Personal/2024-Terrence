...
public class RobotContainer {
  ...
  private final Shoot2Balls shoot2Comm = new Shoot2Balls(Robot.shootInt);
  ...
  // private final IntakeBoth intakeBoth = new IntakeBoth();
  // private final IntakeBottom intakeBottom = new IntakeBottom();
  // private final IntakeTop intakeTop = new IntakeTop();
