...
public class RobotMap {
  ...
  public static CANSparkMax
    shooter = new CANSparkMax(shooterInt, CANSparkLowLevel.MotorType.kBrushless),
    leftFront = new CANSparkMax(leftFrontInt, CANSparkLowLevel.MotorType.kBrushless), 
    leftBack = new CANSparkMax(leftBackInt, CANSparkLowLevel.MotorType.kBrushless), 
    rightFront = new CANSparkMax(rightFrontInt, CANSparkLowLevel.MotorType.kBrushless), 
    rightBack = new CANSparkMax( rightBackInt, CANSparkLowLevel.MotorType.kBrushless);
